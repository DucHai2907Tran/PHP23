...
//Câu lệnh truy vấn
$query_recent_posts = "SELECT * FROM posts WHERE category_id = 1";
...
//Câu lệnh truy vấn
$query_posts = "SELECT * FROM posts WHERE category_id = 2";
...
//Câu lệnh truy vấn
$query_posts_behind = "SELECT * FROM posts WHERE category_id = 3";
								...
								<div class="post">
									...
									<div class="post-body">
										<div class="post-meta">
											...
											<span class="post-date"><?php echo $post['creat-at'] ?></span>
										</div>
